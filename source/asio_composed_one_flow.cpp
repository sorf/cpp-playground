...
void test_callback(std::chrono::steady_clock::duration run_duration) {
    ...
    async_one_timer(io_context, run_duration, [](error_code const &error) {
        if (error) {
...
void test_callback_strand(std::chrono::steady_clock::duration run_duration) {
    ...
    async_one_timer(io_context, run_duration, asio::bind_executor(strand_timers, [](error_code const &error) {
                        if (error) {
